...
do
    ...
    res=`./$process $inputGraph output_${process}_${numThread}Thread -GMInputFormat="edge" -root=1 -GMMeasureTime=1 -GMNumThreads=$numThread >> OPENMP_${process}_${graphName}_Results`
